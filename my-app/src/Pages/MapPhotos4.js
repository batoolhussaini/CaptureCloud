...
import pic1 from '../Assets/Photos/mapPic22.jpeg';
import pic2 from '../Assets/Photos/mapPic21.webp';
import pic3 from '../Assets/Photos/mapPic23.jpg';
import pic4 from '../Assets/Photos/mapPic24.jpg';
import pic5 from '../Assets/Photos/mapPic25.webp';
import pic6 from '../Assets/Photos/mapPic26.jpg';
import pic7 from '../Assets/Photos/mapPic27.jpg';

function MapPhotos() {
  useEffect(() => { document.title = 'Seoul'; });
  ...
  return (
    <div className="flex flex-col">
      ...
      <h1 className="text-5xl text-center mb-6 text-[#6AABD2] mt-6 ml-32">Seoul, Korea</h1>
