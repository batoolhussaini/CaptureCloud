...
import pic3 from '../Assets/Photos/mapPic3.jpg';
import pic4 from '../Assets/Photos/mapPic4.webp';
import pic5 from '../Assets/Photos/mapPic5.jpg';
import pic6 from '../Assets/Photos/mapPic6.webp';
import pic7 from '../Assets/Photos/mapPic7.webp';
import pic8 from '../Assets/Photos/mapPic8.jpg';
import pic9 from '../Assets/Photos/mapPic9.avif';
import pic10 from '../Assets/Photos/mapPic10.webp';

function MapPhotos() {
  useEffect(() => { document.title = 'France'; });
  ...
  return (
    <div className="flex flex-col">
      ...
      <h1 className="text-5xl text-center mb-6 text-[#6AABD2] mt-6 ml-32">France</h1>
